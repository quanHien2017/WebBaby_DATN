                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="title" placeholder="<?php echo app('translator')->get('Họ tên'); ?>"
                    ...
                    <div class="form-group">
                      <div class="row">
                        ...
                        <input type="number" class="form-control" name="namsinh" placeholder="<?php echo app('translator')->get('Năm sinh'); ?>"
                          value="<?php echo e($detail->namsinh); ?>">
                        </div>
                         <div class="col-md-4">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp7428\htdocs\yenbinh\resources\views/admin/pages/cms_profile/edit.blade.php ENDPATH**/ ?>