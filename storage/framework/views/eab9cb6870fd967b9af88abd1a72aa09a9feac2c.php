                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-control">
                        <label>
                          <input type="radio" name="is_featured" value="active" checked="">
                          <small><?php echo app('translator')->get('Có'); ?></small>
                        </label>
                        <label>
                          <input type="radio" name="is_featured" value="deactive" class="ml-15">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp7428\htdocs\shopquanao\resources\views/admin/pages/cms_taxonomys/create.blade.php ENDPATH**/ ?>