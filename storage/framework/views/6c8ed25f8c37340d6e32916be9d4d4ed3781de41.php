                                    ...
                                    <div class="woocommerce-checkout-payment">
                                        <form method="POST" action="/vnpay_payment"  > 
                                          ...
                                          <input type="hidden" name="tongtien" id="tongtien" value="<?php echo e($total); ?>">
                                           <button name="redirect" type="submit" onclick="saveuser()" class="checkout-button button alt wc-forward"> Thanh toán qua VNPAY</button>
                                       </form>
                                    </div>
                                 </div>
...
<?php /**PATH E:\xampp7428\htdocs\shopquanao\resources\views/frontend/pages/cart/index.blade.php ENDPATH**/ ?>