...
<?php if(isset($slide)): ?>
                                ...
                                <div id="metaslider_404516">
                                    <ul aria-live="polite" class="slides">
                                        <?php $__currentLoopData = $slide; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item_mb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <li style="display: block; width: 100%; height: 500px;" class="slide-536686 ms-image">
                                                <a href="<?php echo e($item_mb->url_link); ?>" target="_self" aria-label="navigation">
                                                    <img data-lazyloaded="1"
                                                    data-src="<?php echo e($item_mb->image); ?>" height="350" width="480" alt="" class="slider-33899 slide-536686" style="object-fit: cover;height: 350px;" title="<?php echo e($item_mb->title); ?>" />
                                                </a>
                                            </li>
                                            <?php endif; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php endif; ?>
<?php endif; ?>        <?php /**PATH E:\xampp7428\htdocs\phongkham\resources\views/frontend/element/slide.blade.php ENDPATH**/ ?>