				            ...
				            <ul aria-live="polite" class="slides">
				                ...
				                <li style="display: block; width: 100%;" class="slide-538432 ms-image">
				                   <a href="/chi-tiet-dich-vu/<?php echo e($item->url_part); ?>.html" target="_self" aria-label="navigation">
				                   	<img data-lazyloaded="1" style="height: 220px;width: 198px;object-fit: cover;" src="<?php echo e($item->json_params->image); ?>" data-src="<?php echo e($item->json_params->image); ?>" height="220" width="198" alt="<?php echo e($item->title); ?>" class="slider-344604 slide-538432 entered litespeed-loaded" title="<?php echo e($item->title); ?>" data-ll-status="loaded">
				                   </a>
	         	...
	         	<div class="widget_question">
				   ...
				   <div class="widget__container">
				      <ul>
				        ...
				        <li>
				        	<h3><a href="/chi-tiet-dich-vu/<?php echo e($dv->url_part); ?>.html" title="<?php echo e($dv->title); ?>"><?php echo e($dv->title); ?></a></h3>
				        </li>
				        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				      </ul>
				   </div>
...
<?php /**PATH E:\xampp7428\htdocs\phongkham\resources\views/frontend/pages/post/detail_dichvu.blade.php ENDPATH**/ ?>