      ...
      <div class="shop-page-title category-page-title page-title ">
         <div class="page-title-inner flex-row  medium-flex-wrap container">
            <div class="flex-col flex-grow medium-text-center">
               <h1 class="shop-page-title is-xlarge">Tìm kiếm sản phẩm</h1>
               <div class="is-small">
                  <nav class="woocommerce-breadcrumb breadcrumbs"><a href="/">Trang chủ</a> <span class="divider">&#47;</span> Tìm kiếm sản phẩm</nav>
               </div>
               ...
               <div id="shop-sidebar" class="sidebar-inner col-inner">
                  ...
                  <aside id="woocommerce_products-3" class="widget woocommerce widget_products">
                     ...
                     <ul class="product_list_widget">
                        <?php $__currentLoopData = $posts_nb; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
               ...
               <div class="shop-container">
                  ...
                  <?php else: ?>
                  	<div class="term-description">
                  		Không tìm thấy sản phẩm theo tiêu chí tìm kiếm
                  	</div>
                  <?php endif; ?>
               </div>
               <!-- shop container -->
...
</html><?php /**PATH E:\xampp7428\htdocs\shopquanao\resources\views/frontend/pages/product/search.blade.php ENDPATH**/ ?>