								...
								<?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<div class="list-2__item">
										<div class="news-4 media">
											<span class="news-4__frame"><img src="<?php echo e($item->image); ?>" onerror="this.src='/public/themes/frontend/yenbinh/themes/chuyennt/images/pngwing.com.png'" alt="<?php echo e($item->title); ?>" /></span>
											<div class="media-body">
												...
												<div class="news-3__desc big_desc"> 
													<?php if($item->chucvu != ''): ?>
														<p>Chức vụ: <?php echo e($item->chucvu); ?></p>
													<?php endif; ?>
													<?php if($item->namsinh != ''): ?>
													<p>Năm sinh: <?php echo e($item->namsinh); ?></p>
													<?php endif; ?>
													<?php if($item->trinhdo != ''): ?>
													<p>Trình độ: <?php echo e($item->trinhdo); ?></p>
													<?php endif; ?>
													<?php if($item->sdt != ''): ?>
													<p>Số điện thoại: <?php echo e($item->sdt); ?></p>
													<?php endif; ?>
													<?php if($item->email != ''): ?>
													<p>Email: <em><strong><?php echo e($item->email); ?></strong></em></p>
													<?php endif; ?>
												</div>
											</div>
										</div>
...
<?php /**PATH E:\xampp7428\htdocs\yenbinh\resources\views/frontend/pages/post/category_profile.blade.php ENDPATH**/ ?>