              ...
              <div class="tab-pane active" id="tab_1">
                ...
                <div class="row" id="info_general">
                  <div class="col-md-8 col-lg-8 col-sm-12 col-xs-12">
                    ...
                    <div class="form-group">
                      <label><?php echo app('translator')->get('Danh sách tài liệu'); ?></label>
                      <div class="input-group">
                        <span class="input-group-btn">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp7428\htdocs\yenbinh\resources\views/admin/pages/cms_posts/create.blade.php ENDPATH**/ ?>