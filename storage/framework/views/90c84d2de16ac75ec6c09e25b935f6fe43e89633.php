<?php
    /**** Dem truy cap ****/
    $path_template = getcwd(); //Hàm getcwd() lấy ra đường dẫn thư mục
    $dir = $path_template . "/counter/"; //Đường dẫn thư mục
    if (!file_exists($dir)) {
        mkdir($dir);
    }
    //echo $dir;
    $counter_expire = 600;
    $counter_filename = $path_template . "/counter/counter.txt";
    ...
    if(isset($_SERVER['HTTP_COOKIE'])){
        $counter_ip = $_SERVER['HTTP_COOKIE'];
    }else{
	...
	<div class="aside__body">
		<div class="statistic">
			<div class="statistic__item">
				<div class="statistic__label">Hôm nay</div>
			...
			<div class="statistic__item">
				<div class="statistic__label">Tháng hiện tại</div>
				<div class="statistic__numbers">
					<?php echo e($month); ?>
...
</section><?php /**PATH E:\xampp7428\htdocs\phongkham\resources\views/frontend/element/truycap.blade.php ENDPATH**/ ?>