            ...
            <div class="large-9 col medium-col-first">
                  <div class="row large-columns-3 medium-columns- small-columns-1 row-masonry">
                     ...
                     <div class="col post-item" >
					   <div class="col-inner">
					      <a href="/chi-tiet/{{ $items->url_part }}" class="plain">
					         <div class="box box-text-bottom box-blog-post has-hover">
					            <div class="box-image" >
					               <div class="image-cover" style="padding-top:56%;">
					                  <img width="300" height="169" src="{{ $items->image }}" data-src="{{ $items->image }}" class="lazy-load attachment-medium size-medium wp-post-image" alt="" sizes="(max-width: 300px) 100vw, 300px" />  							  							  						
					               </div>
					            </div>
					            <!-- .box-image -->
					            <div class="box-text text-left" >
					               <div class="box-text-inner blog-post-inner">
					                  <h5 class="post-title is-large ">{{ $items->title }}</h5>
					                  <div class="is-divider"></div>
					                  
					                  <p class="from_the_blog_excerpt ">{{ $items->brief }}</p>
					               </div>
					               <!-- .box-text-inner -->
					            </div>
					         </div>
