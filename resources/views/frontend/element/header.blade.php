 ...
 <div class="header-wrapper">
    ...
    <div id="id01" class="modal">
      ...
      <form class="modal-content animate" action="{{ route('frontend.login.post') }}" method="post">
         @csrf 
...
<div id="id02" class="modal1">
   ...
   <form class="modal-content1 animate" action="{{ route('frontend.register') }}" method="post">
      @csrf 
