...
<div class="row row-small"  id="row-68276556">
   @foreach($danhmucnoibat as $k => $item)
    <div class="col medium-4 small-12 large-4"  >
       <div class="col-inner"  >
          <div class="banner has-hover bg-zoom hide-for-small" id="banner-{{ $k }}">
             ...
             <style scope="scope">
                ...
                #banner-{{ $k }} .bg.bg-fill {
                background-image: url({{ $item->json_params->image }});
                }
                #banner-{{ $k }} .overlay {
