                ...
                <div class="row">
                  ...
                  {{-- </div>
					...
					<div class="form-group hidden">
                      <label>@lang('Image điện thoại')</label>
                      <div class="input-group">
                        <span class="input-group-btn">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group hidden">
                      ...
                      <input type="text" class="form-control" id="link_iframe" name="link_iframe" placeholder="Mã nhúng video" value="{{ old('link_iframe') ?? $detail->link_iframe }}">
                    </div>
                  </div>
